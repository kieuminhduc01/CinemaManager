...
namespace QuanLyPhongVe.View
{
    public partial class Login : Form
    {
        ...
        bool checkUserNameAndPassWord()
        {
            ...
            {
                if (acc.TenQuyen.Equals("quanlyrap") && acc.Email == txtUserName.Text && acc.Password == txtPassword.Text)
                {
        ...
        private void ckbShow_CheckedChanged_1(object sender, EventArgs e)
        {
            if (ckbShow.Checked)
