<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="WebBanVe.Home" %>
        ...
        <div class="super_container">
            ...
            <div>
                ...
                <div class="home" style="height: 450px">
                    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/HomeAst.png" data-speed="0.8"></div>
                            ...
                            <asp:Repeater ID="rptPaging" runat="server">
                                <ItemTemplate>
                                    <div style="width: 300px">
                                        ...
                                        <div style="display: flex; justify-content: center">
                                            <label style="color: darkred; font-weight: bold"><%#Eval("tenphim").ToString()%> </label>
                                        </div>
                                        <div style="display: flex; justify-content: center">
                                            <asp:ImageButton ID="ibtnChiTiet" runat="server" ImageUrl="~/images/movie_ticket_60px.png" PostBackUrl=' <%# Eval("tenphim","~/FilmDetail.aspx?phim={0}") %>' />
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
            ...
            <div class="newsletter">
                <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/astralis-logo-art-red-team.jpg" data-speed="0.8"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="newsletter_content text-center">
                                <div class="newsletter_title_container">
                                    <div class="newsletter_title">subscribe to our cinema</div>
